				...
				headers: [
					...
					// Content Security Policy - prevent XSS and injection attacks
					{
						...
						value: [
							...
							`connect-src 'self' ${API_DOMAINS} https://*.googleapis.com https://maps.googleapis.com https://open.spotify.com https://*.s3.amazonaws.com https://*.digitaloceanspaces.com  https://cdn.sanity.io https://*.blob.vercel-storage.com https://fcm.googleapis.com https://firebaseinstallations.googleapis.com blob:`,
