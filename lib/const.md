...
- API CONFIGURATION
- -----------------------------------------\*/
  // Server-side: prefer internal Docker URLs; client-side: falls back to NEXT*PUBLIC*
  ...
  AUTH_API: process.env.AUTH_API_URL || process.env.NEXT_PUBLIC_AUTH_API_URL,
  };

// baseUrl removed — was dead code (never imported). Use AUTH_API or NEXT_PUBLIC_CONNECT_API_URL instead.
export const URLS = {
contact: {
...
confirm_booking: "/api/artisan/bookings/{profileId}/{bookingId}/confirm",
start_booking: "/api/artisan/bookings/{profileId}/{bookingId}/start",
complete_booking: "/api/artisan/bookings/{profileId}/{bookingId}/complete",
