        ...
        {featured.length > 0 && !search && !selectedCategory && (
          <section className="space-y-3">
            ...
            <div className="grid grid-cols-2 gap-3">
              {featured.map((a) => (
                <ArtisanCard key={a.id} artisan={a} featured />
              ))}
            </div>
          </section>
        )}
        ...
        <section className="space-y-3">
          ...
          {loading ? (
            ...
            <div className="py-12 text-center text-white/40">
              <p className="text-sm font-medium mb-1">No artisans found</p>
        ...
        <div className="flex items-center gap-3 text-[10px] text-white/50">
          {artisan.averageRating > 0 && (
            <span className="flex items-center gap-0.5">
              ...
              <span className="text-white/30">({artisan.totalReviews})</span>
            </span>
          )}
          ...
          {startingPrice && (
            <span>From ₦{startingPrice.price?.toLocaleString()}</span>
          )}
        </div>
