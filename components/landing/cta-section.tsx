...
export function CtaSection() {
  ...
  return (
    <section id="cta" ref={ref} className="relative py-20 md:py-32 px-5 md:px-10">
        ...
        >
          ...
          <motion.div variants={fadeInUp} className="relative">
            ...
            <p className="mt-5 md:mt-6 text-base md:text-lg text-zinc-400 max-w-lg mx-auto leading-relaxed">
              ...
              Create your digital profile in minutes — share via QR code,
              NFC smart devices, or a simple link. Start free, no device required.
            </p>
