...
const screens = [
	{
		id: 'profile',
		label: 'Profile',
		src: '/images/previews/profile.png',
				...
				>
					...
					<motion.div variants={fadeInUp}>
						...
						<p className='mt-5 text-base md:text-lg text-zinc-400 leading-relaxed'>
							Your Connect profile is a living, breathing
							representation of your professional identity. Rich
							with modules for contacts, socials, links, files,
							and more. Share it via NFC devices, QR codes, or
							just a link.
						</p>
