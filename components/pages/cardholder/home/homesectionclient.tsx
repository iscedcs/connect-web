					...
					[
						{
							...
							label: 'Wristband',
							iconSrc:
								'/assets/2701e4aa55ab26bea712d31de18c7bcc5e655929.png',
							lastSeenLabel: 'Now',
						},
						{
							id: '2',
							label: 'II Sticker',
							iconSrc:
								'/assets/b31eff4fd906e021018be419d1f70aa5c7080e38.png',
							lastSeenLabel: 'Now',
						},
					] as any
				}
			...
			<ConnectManagementList
				rows={[
					...
					},
					{
						...
						title: 'Calendly',
						subtitle:
							'Share your meeting schedules with friends & colleagues',
					...
					},
					{
						id: 'forms',
						iconSrc:
							'/assets/abc81489af0decc890b6bbda5976cb30fd9985f2.png',
						title: 'Google forms',
			...
			<StoreManagementTable
				products={[
					...
					},
					{
						...
						qty: 1,
						thumbSrc:
							'/assets/Sa5c75ca9999e40d4af8a2aab17cc448dL.svg',
					},
					{
						id: 'airpods',
