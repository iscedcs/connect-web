        ...
        <div className="relative z-10 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8">
          <div className="space-y-3 max-w-xl">
            <h2 className="text-2xl md:text-3xl font-bold tracking-tight text-white">
              Share LYNCON & earn rewards
            </h2>
            <p className="text-sm md:text-base text-neutral-400 leading-relaxed">
              Invite your friends to LYNCON. They get access to seamless digital
              cards and payments, and you earn a cash bonus for every friend who
        ...
        <DialogContent className="bg-neutral-900 border border-white/10 text-white max-w-md rounded-2xl">
          <DialogHeader>
            ...
            <DialogDescription className="text-neutral-400 text-sm">
              ...
              negotiated reward rate. Our team will review it and reach out with
              next steps.
            </DialogDescription>
          </DialogHeader>
