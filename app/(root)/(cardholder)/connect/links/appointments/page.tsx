		...
		<main className='min-h-screen bg-black text-white'>
			...
			<section className='px-5 pt-10 pb-4 relative'>
				...
				<p className='text-white/60 text-sm mt-3 leading-relaxed max-w-md'>
					Your time is valuable. Create dedicated booking links,
					manage their visibility, and guide people to the right
					conversation — whether it's a discovery call, consultation,
