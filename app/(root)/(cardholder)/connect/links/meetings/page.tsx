		...
		<main className='min-h-screen bg-black text-white'>
			...
			<section className='px-5 pt-10 pb-4 relative'>
				...
				<p className='text-white/60 mt-3 max-w-md text-sm leading-relaxed'>
					Make it easy for people to schedule time with you. Add your
					meeting platforms, manage visibility, and set your default
					link for professional conversations, networking, and
					collaborations.
				</p>
