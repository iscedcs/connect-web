			...
			<main className='min-h-screen flex items-center justify-center bg-black text-white px-5'>
				<div className='text-center'>
					...
					<p className='text-sm text-white/50 mt-1'>
						This profile doesn&apos;t exist or has no slug assigned.
					</p>
					<Link
						href='/profiles'
						className='inline-block mt-4 px-5 py-2 bg-white text-black rounded-full text-sm font-medium'
					>
						Back to profiles
					</Link>
				</div>
			...
			<div className='sticky top-0 z-50 bg-amber-500/90 backdrop-blur-sm text-black px-4 py-2.5 flex items-center justify-between gap-3'>
				...
				<div className='flex items-center gap-2'>
					<Link
						href={`/p/${slug}`}
						target='_blank'
						className='inline-flex items-center gap-1 px-3 py-1 bg-black/10 rounded-full text-xs font-medium hover:bg-black/20 transition'
					>
					...
					<Link
						href='/profiles'
						className='inline-flex items-center gap-1 px-3 py-1 bg-black/20 rounded-full text-xs font-medium hover:bg-black/30 transition'
					>
